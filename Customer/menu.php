			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="menu.php?id=<?php echo $id ?>">Product</a></li>
    ...
    ?>
        <div class="card" style="width: 21rem;">
            ...
            <div class="card-body">
                ...
                <center>
                	<a style="background-color: #f5d4a9; border-color: #f5d4a9; color: black;" href="cartAction.php?action=addToCart&id=<?php echo $row["id"]?>&p_id=<?php echo $id;?>" class="btn btn-primary">Add to Cart</a>
                </center> 
            </div>
