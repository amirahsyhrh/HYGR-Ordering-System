...
<div class="container">
    <br><br><br>
    <h1 style="font-size: 35px"><b>CHECKOUT</b> </h1>
    <div class="col-12">
        <div class="checkout">
            <div class="row">
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        <span style="font-size: 18px; color: black;">Your Cart</span>
                    ...
                    ?>
                        <li class="list-group-item d-flex justify-content-between lh-condensed">
                            <div>
                                <h6 style="font-size: 18px; color: black;"><?php echo $item["name"]; ?></h6>
                                <small style="font-size: 18px; color: black;"><?php echo "RM".$item["price"]. " "; ?>(<?php echo  $item["qty"]; ?>)</small>
                            </div>
                            <span style="font-size: 18px; color: black;"><?php echo "RM".$item["subtotal"]; ?></span>
                        </li>
                    <?php } } ?>
                        <li class="list-group-item d-flex justify-content-between">
                            <span style="font-size: 18px; color: black;">Total (<?php echo "RM "; ?>)</span>
                            <strong><?php echo "RM ".$cart->total(); ?></strong>
                        </li>
                    </ul>
                    <a href="menu.php?id=<?php echo $id;?>" class="btn btn-sm btn-info">+ add items</a>
                </div>
                <div class="col-md-8 order-md-1">
                    <h4 class="mb-3" style="font-size: 18px">Contact Details</h4>
                    <form method="post" action="cartAction.php?p_id=<?php echo $id;?>">
                        <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" value="<?php echo $id;?>" required>
                        </div>
                        <div class="mb-3">
