	<?php
		...
		$sql="INSERT INTO `order`(order_fullname, order_address, order_phonenumber, order_email, order_notes, order_details, order_totalpayment) VALUES ('$cname','$caddress', '$cphone', '$cemail', '$cnotes', '$cdetails', '$ctotalprice')";
